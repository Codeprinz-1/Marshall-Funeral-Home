var func2 = function() {
  ...
  $('#services-header').css({'background-image': 'linear-gradient(180deg, rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.3)),  url(../Images/services-image-01.jpg)'})
...
var func3 = function() {
  ...
  $('#services-header').css({'background-image': 'linear-gradient(180deg, rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.3)),  url(../Images/header-image-cremation.jpg)'})
  $('.content-link').removeClass('selected')
...
var func4 = function() {
  ...
  $('#services-header').css({'background-image': 'linear-gradient(180deg, rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.3)),  url(../Images/header-image-personalization.jpg)'})
  $('.content-link').removeClass('selected')
...
var func5 = function() {
  ...
  $('#services-header').css({'background-image': 'linear-gradient(180deg, rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.3)),  url(../Images/header-image-veteran.jpg)'})
  $('.content-link').removeClass('selected')
...
var func6 = function() {
  ...
  $('#services-header').css({'background-image': 'linear-gradient(180deg, rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.3)),  url(../Images/header-image-services-overview.jpg)'})
  $('.content-link').removeClass('selected')
